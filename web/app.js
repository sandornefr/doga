  ...
  try {
    ...
    monaco.editor.defineTheme("vizsga-light", {
      ...
      rules: [
        ...
        { token: "tag", foreground: "00268C", fontStyle: "bold" },
        { token: "tag.html", foreground: "00268C", fontStyle: "bold" },
        { token: "delimiter", foreground: "222222" },
        { token: "delimiter.html", foreground: "222222" },
        { token: "attribute.name", foreground: "7B2800", fontStyle: "bold" },
        { token: "attribute.name.html", foreground: "7B2800", fontStyle: "bold" },
        { token: "attribute.value", foreground: "005C00", fontStyle: "bold" },
        { token: "attribute.value.html", foreground: "005C00", fontStyle: "bold" },
        { token: "string", foreground: "005C00", fontStyle: "bold" },
        { token: "string.html", foreground: "005C00", fontStyle: "bold" },
        { token: "comment", foreground: "555555", fontStyle: "italic" },
        { token: "comment.html", foreground: "555555", fontStyle: "italic" },
        { token: "keyword", foreground: "00268C", fontStyle: "bold" },
        { token: "number", foreground: "8B0000" },
      ],
      colors: {
        ...
        "editor.selectionBackground": "#4D90FE55",
