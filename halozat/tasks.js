  ...
  // ═══════════════════════════════════════════════════════
  {
    ...
    topologia: {
      eszkozok: [
        ...
        { id: 'gondor-sw2',    tipus: 'switch',     nev: 'GONDOR-SW2',    x: 620, y: 445, ghost: true },
        { id: 'user-laptop',   tipus: 'laptop',     nev: 'USER-laptop',   x: 710, y: 445 },
      ...
      kapcsolatok: [
        ...
        { tol: 'gondor-sw1', ig: 'gondor-sw2',    port1: 'Fa0/4', port2: 'Fa0/1' },
        { tol: 'gondor-sw2', ig: 'user-laptop',   port1: 'Fa0/2', port2: 'NIC' },
  ...
  // ═══════════════════════════════════════════════════════
  {
    ...
    topologia: {
      eszkozok: [
        ...
        { id: 'tower-sw1',    tipus: 'switch',     nev: 'TOWER-SW1',     x: 580, y: 310 },
        { id: 'tower-server', tipus: 'server',     nev: 'TOWER-Server',  x: 720, y: 200, elokonfig: true },
        { id: 'tower-pc',     tipus: 'laptop',     nev: 'TOWER-PC',      x: 720, y: 380, hibas: true },
        { id: 'tower-sw2',    tipus: 'switch',     nev: 'TOWER-SW2',     x: 620, y: 445, ghost: true },
        { id: 'user-laptop',  tipus: 'laptop',     nev: 'USER-laptop',   x: 710, y: 445, ghost: true },
        { id: 'guest-wifi',   tipus: 'homerouter', nev: 'GUEST-WIFI',    x: 180, y: 230 },
        { id: 'guest-phone',  tipus: 'phone',      nev: 'GUEST-phone',   x:  70, y: 150 },
        { id: 'guest-tablet', tipus: 'tablet',     nev: 'GUEST-tablet',  x:  70, y: 340 },
      ],
      kapcsolatok: [
        ...
        { tol: 'tower-sw1', ig: 'tower-sw2',    port1: 'Fa0/4', port2: 'Fa0/1' },
        { tol: 'tower-sw2', ig: 'user-laptop',  port1: 'Fa0/2', port2: 'NIC' },
